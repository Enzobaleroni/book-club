                ...
                <div class="product-gallery">
                    <div class="thumbnail-list">
                        <div class="thumbnail active" onclick="changeImage('o poder do habito.jpg')">
                            <img src="img//o poder do habito.jpg" alt="Capa do Livro">
                        </div>
                         
                    </div>
                    
                    <div class="main-image">
                        <img src="img//o poder do habito.jpg" alt="O Poder do Hábito" id="mainProductImage">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <div class="product-card-info">
                        <h3 class="product-card-title">a arte da guerra</h3>
                        <div class="product-card-price">
